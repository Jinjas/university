...
public class Encomenda {
    ...
    public Encomenda (String clientName, String fiscal, String morada, int idEncomenda,String data,int nlinhas,ArrayList<LinhaDeEncomenda> lista){
        ...
        this.data = data;
        this.linhasEncomendas = new ArrayList<LinhaDeEncomenda>();
        Iterator<LinhaDeEncomenda> it = lista.iterator();
        while(it.hasNext()){
            LinhaDeEncomenda c = it.next();
            this.linhasEncomendas.add(c);
        }
    }
    public Encomenda (Encomenda that){

        this.clientName =that.clientName;
        this.fiscal = that.fiscal;
        this.morada =that. morada;
        this.idEncomenda = that.idEncomenda;
        this.data = that.data;
        this.linhasEncomendas = new ArrayList<LinhaDeEncomenda>();
        Iterator<LinhaDeEncomenda> it = that.linhasEncomendas.iterator();
        while(it.hasNext()){
            LinhaDeEncomenda c = it.next();
            this.linhasEncomendas.add(c);
        }
